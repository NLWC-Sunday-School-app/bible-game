...
void showGlobalChallengeLeaderboardModalTabletView(BuildContext context, String gameType) {
  showModalBottomSheet(
      context: context,
      isScrollControlled: true,
      isDismissible: true,
      builder: (BuildContext context) {
        return LeaderboardModalTabletView(gameType: gameType,);
      });
}

class LeaderboardModalTabletView extends StatefulWidget {
  final String gameType;
  const LeaderboardModalTabletView({
    Key? key, required this.gameType,
  }) : super(key: key);

  @override
  State<LeaderboardModalTabletView> createState() => _GamesBottomSheetModalState();
}

class _GamesBottomSheetModalState extends State<LeaderboardModalTabletView> {
  @override
  void initState() {
    super.initState();

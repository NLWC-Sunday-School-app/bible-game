...
class GlobalQuestionScreenTabletView extends StatefulWidget {
  final GlobalChallengeRepository globalChallengeRepository;

  const GlobalQuestionScreenTabletView(
      {super.key, required this.globalChallengeRepository});

  @override
  State<GlobalQuestionScreenTabletView> createState() => _GlobalQuestionScreenTabletViewState();
}

class _GlobalQuestionScreenTabletViewState extends State<GlobalQuestionScreenTabletView>

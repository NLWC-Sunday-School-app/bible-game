...
import 'package:the_bible_game/features/home/widget/modals/log_out_modal.dart';
                            ...
                            children: [
                              Container(
                                ...
                                SvgPicture.network(
                                  ...
                                  width: 70.w,
                                  semanticsLabel: 'Logo',
                                  placeholderBuilder: (BuildContext context) => Image.asset(ProductImageRoutes.defaultAvatar, width: 70.w,),
                                ),
                ...
                BlocConsumer<UserBloc, UserState>(
                  listener: (context, state) {
                    if(state.hasSentCollaboratorMail){
                      Flushbar(
                        message: 'Thank you, a mail has been sent to you!',
                  ...
                  builder: (context, state) {
                    return Padding(
                      ...
                      child: GestureDetector(
                        onTap: () {
                          context.read<UserBloc>().add(OnboardCollaborator());
                        },
                        child: Container(
                          width: double.infinity,
                          padding: EdgeInsets.symmetric(
                ...
                Row(
                  ...
                  children: [
                    IconButton(
                      ...
                      onPressed: () {
                        _launchURL('https://www.instagram.com/ourbiblegame');
                      },
                    ),
                    SizedBox(
                      width: 50.w,

...
class UserProfileInfoTabletView extends StatelessWidget {
  const UserProfileInfoTabletView(
      {Key? key,
                  ...
                  InkWell(
                    child: Container(
                        padding: EdgeInsets.only(
                            left: 30.w, right: 5.w, top: 8.h, bottom: 8.h),
                        decoration: BoxDecoration(
                          color: Colors.white,
                          borderRadius: BorderRadius.only(
                            topRight: Radius.circular(4.r),
              ...
              child: InkWell(
                child: Container(
                  ...
                  child: Container(
                    ...
                    child:
                        AvatarWidget( seed: avatarUrl, width: 68.w, height: 68.h,),

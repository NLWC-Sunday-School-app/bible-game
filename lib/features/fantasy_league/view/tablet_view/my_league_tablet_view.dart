...
class MyLeagueScreenTabletView extends StatefulWidget {
  const MyLeagueScreenTabletView({super.key});

  @override
  State<MyLeagueScreenTabletView> createState() => _MyLeagueScreenTabletViewState();
}

class _MyLeagueScreenTabletViewState extends State<MyLeagueScreenTabletView> {
  @override

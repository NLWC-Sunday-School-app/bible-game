...
void showFantasyBibleLeagueGuide(BuildContext context){
    showModalBottomSheet(
      context: context,
      isDismissible: false,
      isScrollControlled: true,
      builder: (BuildContext context){
        return FantasyBibleLeagueGuide();
      }
    );
}


class FantasyBibleLeagueGuide extends StatelessWidget {
  const FantasyBibleLeagueGuide({super.key});

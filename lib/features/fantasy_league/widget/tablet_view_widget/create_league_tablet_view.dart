...
import 'package:bible_game/features/fantasy_league/widget/tablet_view_modal/successfully_created_league_modal_tablet_view.dart';
import 'package:bible_game/shared/constants/image_routes.dart';
import 'package:bible_game/shared/utils/validation.dart';
...
class CreateLeagueTabletView extends StatefulWidget {
  final double screenHeight;

  const CreateLeagueTabletView({super.key, required this.screenHeight});

  @override
  State<CreateLeagueTabletView> createState() => _CreateLeagueTabletViewState();
}

class _CreateLeagueTabletViewState extends State<CreateLeagueTabletView> {
    ...
    return BlocConsumer<FantasyLeagueBloc, FantasyLeagueState>(
      listener: (context, state) {
        ...
        if (state.hasCreatedLeague) {
          showSuccessfullyCreatedModalTabletView(context);

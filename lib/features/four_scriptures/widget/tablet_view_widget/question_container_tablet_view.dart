...
class QuestionContainerTabletView extends StatefulWidget {
  ...
  @override
  State<QuestionContainerTabletView> createState() => _QuestionContainerTabletViewState();
}

class _QuestionContainerTabletViewState extends State<QuestionContainerTabletView> {
              ...
              child: Column(
                children: [
                  GridView.count(
                    ...
                    crossAxisCount: 2,
                    crossAxisSpacing: 160.w,
                    mainAxisSpacing: 64.h,
                    children: [
                      ScriptureBoxTabletView(
                        scripture:

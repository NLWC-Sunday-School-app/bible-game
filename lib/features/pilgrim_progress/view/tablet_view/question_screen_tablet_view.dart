...
import 'package:bible_game/shared/widgets/tablet_view_modal/game_summary_tablet_view_modal.dart';
import 'package:bible_game/shared/widgets/tablet_view_widget/question_container_tablet_view.dart';
...
class PilgrimQuestionScreenTabletView extends StatefulWidget {
  final AuthenticationBloc authenticationBloc;
  final PilgrimProgressRepository pilgrimProgressRepository;
  const PilgrimQuestionScreenTabletView({super.key, required this.authenticationBloc, required this.pilgrimProgressRepository});

  @override
  State<PilgrimQuestionScreenTabletView> createState() => _PilgrimQuestionScreenTabletViewState();
}

class _PilgrimQuestionScreenTabletViewState extends State<PilgrimQuestionScreenTabletView> with SingleTickerProviderStateMixin {
  ...
  void _moveToNextPage() {
    ...
    if (_currentPage < (pilgrimProgressState.pilgrimProgressQuestions?.length ?? 0) - 1) {
      ...
      showGameSummaryTabletViewModal(
        context: context,

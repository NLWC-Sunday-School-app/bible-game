...
class WhoIsWhoLevelTabletView extends StatefulWidget {
  const WhoIsWhoLevelTabletView(
      {Key? key,
  ...
  @override
  State<WhoIsWhoLevelTabletView> createState() => _WhoIsWhoLevelTabletViewState();
}

class _WhoIsWhoLevelTabletViewState extends State<WhoIsWhoLevelTabletView> {

...
class WhoIsWhoQuestionScreenTabletView extends StatefulWidget {
  const WhoIsWhoQuestionScreenTabletView({
    super.key,
  });

  @override
  State<WhoIsWhoQuestionScreenTabletView> createState() => _WhoIsWhoQuestionScreenTabletViewState();
}

class _WhoIsWhoQuestionScreenTabletViewState extends State<WhoIsWhoQuestionScreenTabletView>

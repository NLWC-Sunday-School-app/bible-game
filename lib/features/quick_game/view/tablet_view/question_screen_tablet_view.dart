...
class QuickGameQuestionScreenTabletView extends StatefulWidget {
  final AuthenticationBloc authenticationBloc;
  final QuickGameRepository quickGameRepository;

  const QuickGameQuestionScreenTabletView(
      {super.key,
      required this.authenticationBloc,
      required this.quickGameRepository});

  @override
  State<QuickGameQuestionScreenTabletView> createState() =>
      _QuickGameQuestionScreenTabletViewState();
}

class _QuickGameQuestionScreenTabletViewState extends State<QuickGameQuestionScreenTabletView>

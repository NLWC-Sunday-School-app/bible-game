...
void showGameSummaryTabletViewModal(
  ...
  showDialog(
      ...
      builder: (BuildContext context) {
        return Dialog(
          ...
          child: GameSummaryTabletViewModal(
...
class GameSummaryTabletViewModal extends StatelessWidget {
  const GameSummaryTabletViewModal(
      {super.key,
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        image: DecorationImage(
          image: AssetImage(ProductImageRoutes.gameSummaryBgTabletView),
          fit: BoxFit.fill,
        ),
      ),
      child: Column(

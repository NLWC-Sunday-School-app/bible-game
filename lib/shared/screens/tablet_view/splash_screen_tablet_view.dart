...
class SplashScreenTabletView extends StatefulWidget {
  const SplashScreenTabletView({Key? key}) : super(key: key);

  @override
  State<SplashScreenTabletView> createState() => _SplashScreenTabletViewState();
}

class _SplashScreenTabletViewState extends State<SplashScreenTabletView> {
  @override
        ...
        Container(
          decoration: const BoxDecoration(
            image: DecorationImage(
              image: AssetImage(ProductImageRoutes.splashScreenLoaderBgTabletView),
              fit: BoxFit.cover,
            ),
          ),
        ),

...
class YoungBelieverQuestionScreen extends StatelessWidget {
  const YoungBelieverQuestionScreen({Key? key}) : super(key: key);
  static String routeName = "/young-believer-question-screen";

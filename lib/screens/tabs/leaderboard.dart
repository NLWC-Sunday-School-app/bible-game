              ...
              ()=> Row(
                  ...
                  children: [
                    ...
                    () => LeaderBoardBaseChampions(
                        ...
                        avatarUrl: '${BaseUrlService.avatarBaseUrl}/${leaderboardController.leaderboardData[1].playerId}.png?apikey=${BaseUrlService.avatarApiKey}',
                    ...
                    leaderboardController.leaderboardData.isNotEmpty ? Obx( ()=> LeaderBoardChampion(
                        ...
                        avatarUrl:  '${BaseUrlService.avatarBaseUrl}/${leaderboardController.leaderboardData[0].playerId}.png?apikey=${BaseUrlService.avatarApiKey}',
                    ...
                    leaderboardController.leaderboardData.length >= 3 ? Obx(
                      () => LeaderBoardBaseChampions(
                        ...
                        avatarUrl: '${BaseUrlService.avatarBaseUrl}/${leaderboardController.leaderboardData[2].playerId}.png?apikey=${BaseUrlService.avatarApiKey}',

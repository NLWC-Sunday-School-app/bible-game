        ...
        builder: (controller) {
          return Column(
            ...
            children: [
              ...
              (controller.animation.value * 20).round()  <= 5 ?
              FadeTransition(
                opacity: controller.blinkingController,
                child: Text(
                  "00:${(controller.animation.value * 20).round() < 10 ? '0' : ''}${(controller.animation.value * 20).round()}",
                  style: TextStyle(
                      fontSize: 34.sp,
                      fontWeight: FontWeight.w500,

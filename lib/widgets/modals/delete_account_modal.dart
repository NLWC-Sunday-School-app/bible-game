...
class DeleterAccountModal extends StatelessWidget {
  const DeleterAccountModal({Key? key}) : super(key: key);
            ...
            children: [
              ...
              GestureDetector(
                ...
                _userController.soundIsOff.isFalse ? _userController.playGameSound() : null,
                  authController.deleteAccount(_userController.myUser['id'])
                ...
                child: Obx(
                    ...
                    child: authController.isDeletingAccount.isTrue
                        ? const Center(
                      child: SizedBox(
                          height: 20,
                          width: 20,

...
class ScoreCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return SizedBox(
      height: 150.h,
      child: GetBuilder<PilgrimProgressQuestionController>(
          init: PilgrimProgressQuestionController(),
                      ...
                      child: Container(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Obx(
                                  () => Text(
                                '${_questionController.questionNumber.toString()}/${_questionController.questions.length}',
                                style: TextStyle(
                                    fontSize: 24.sp,
                                    fontWeight: FontWeight.w900,
                                    color: const Color(0xFF3574E2),
